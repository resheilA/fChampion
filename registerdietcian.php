		...
		.form-control{margin:0.5em;}
          ...
          <h1 class="mt-4">Journey to Coach India!</h1><hr>
						<?php if(isset($error_mysql)){echo $error_mysql;} ?>
							...
							<input type="hidden" name="dieticians|dieticians_id" value="<?php echo rand(1000,999999999); ?>" placeholder="Enter your name" value="" class="form-control">
							<input type="text" name="dieticians|dieticians_name" value="" placeholder="Enter your name" value="" class="form-control">							
							<input type="text" name="dieticians|dieticians_contact" value="" placeholder="Enter your contact number" value="" class="form-control">							
							<input type="text" name="dieticians|dieticians_email" value="" placeholder="Enter your email" value="" class="form-control">							
							<textarea  class="form-control" name="dieticians|dieticians_address" placeholder="Enter your address"></textarea>
							<input type="text" name="dieticians|dieticians_pincode" value="" placeholder="Enter your pincode" value="" class="form-control">							
							<textarea  class="form-control" name="dieticians|dieticians_about" placeholder="Enter summary about the you in about 100 words"></textarea>
							<textarea  class="form-control" name="dieticians|dieticians_achievements" placeholder="Enter your achievments"></textarea>
